...
const Login = ({ navigation }) => {
    ...
    const handleLogin = async () => {
        ...
        try {
            const response = await fetch('https://reqres.in/api/users?page=2/Login', {
                method: 'POST',
                headers: {
            ...
            if (!response.ok||!data.token) {
                ...
                const errorMessage = data.message || 'An error occurred while logging in. Please try again later.';
        ...
        >
            <ScrollView>
                <View style={styles.box}>
                    ...
                    <Text style={styles.head_text} >Login in to your Account</Text>
